...
const VoiceInput = ({ isListening, toggleListening }) => {
    return (
        <div className={`bg-white rounded-2xl shadow-sm border transition-all duration-500 ease-in-out p-6 hover:shadow-[0_0_20px_rgba(20,184,166,0.3)] hover:scale-[1.02] lg:flex-none ${isListening ? 'border-teal-400 ring-2 ring-teal-50' : 'border-gray-100 hover:border-teal-200'}`}>
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <Mic className="w-5 h-5 text-teal-600" /> Real-time Voice
            </h3>
            <div className="flex flex-col items-center justify-center py-6 lg:py-3 gap-4">
                <button
